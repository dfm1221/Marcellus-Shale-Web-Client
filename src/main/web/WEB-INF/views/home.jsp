...
<body>
<a name="top"></a>
<p>This template provides a starting point for creating your Web application. This easily configurable template allows you to define the map, title and links for the site. This read-me file explains how to viewer.setup and configure the template to run on your web server.</p>
...
<p>These instructions assume that you have a Web server like <a href="http://www.iis.net/">Internet Information Services(IIS)</a> installed and viewer.setup on your machine. If you are using another Web server the general installation steps will be the same but you will need to check your Web server's documentation for specific information on deploying and testing the application.
...
<ol>
    ...
    <li>If your application edits features in a feature service, enables the elevation chart, contains secure services or web maps that aren't publicly shared or generates requests that exceed 2000 characters you may need to
        viewer.setup and use a proxy page. Common situations where you may exceed the URL length are, using complex polygons as input to a task or specifying a spatial reference using well-known text (wkt).
...
bingMapsKey = "<span class="selector">Enter your Bing Maps Key here</span>";
 ...
 <pre>
    ...
    <li>In order to execute a print task, you need to specify a link to your geoprocessing service.</li>
 <pre>
 printtask:"<span class="selector">http://&#60;link to your geoprocessing service&#62;/Utilities/PrintingTools/GPServer/Export%20Web%20Map%20Task</span>",
 </pre>
...
<ol>
    ...
    <br />
    <br />
    <li>Modify sharing URL to point to your sharing service URL if you are using the portal.</li>
